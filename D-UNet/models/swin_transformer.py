...
#             img_size=img_size, patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim, norm_layer=None)
#
...
#             x = block(x, x_size, params['rpi_sa'], params['attn_mask'])
#
...
#     model = BasicLayer(upscale=2, img_size=(height, width),
