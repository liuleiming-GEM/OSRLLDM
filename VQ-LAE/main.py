...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-n", "--name", type=str, const=True, default="X4_fisheye", nargs="?", help="postfix for logdir", )
    parser.add_argument("-r", "--resume", type=str, const=True, default=r"", nargs="?",
...
############################################### Keep the 5 checkpoints with the best performance.
