...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-i", "--in_path", type=str, default=r"E:\liu\database\paper4\odi360\testing", help="Input path.")
    # parser.add_argument("-i", "--in_path", type=str, default=r"D:\liuleiming\testing\SUN", help="Input path.")
    parser.add_argument("--yaml_name", type=str, default="X4_fisheye", help="Name of the YAML.")
    parser.add_argument("-o", "--out_path", type=str, default="./results/X4_fisheye", help="Output path.")
