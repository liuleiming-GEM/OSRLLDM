...
class oditra(Dataset):
    def __init__(self, dictC):
        ...
        inputs_BIC = os.path.join(db_dir, 'crop_LR_bicubic_fisheye', 'X2')
...
class odival(Dataset):
    def __init__(self, dictC):
        ...
        inputs_LR = os.path.join(db_dir, 'LR_fisheye', 'X2')
        inputs_BIC = os.path.join(db_dir, 'LR_bicubic_fisheye', 'X2')
