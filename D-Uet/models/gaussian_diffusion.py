...
def get_named_eta_schedule(
    ...
    The eta schedule library consists of eta schedules which remain similar eta
    in the limit of num_diffusion_timesteps.
    """
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        :param Mat_64: the [N x C x ...] tensor of latitude distortion maps.
        :param z_BIC: the [N x C x ...] tensor of latent representation of interpolated images.
    ...
    def p_sample_loop(
        ...
        :param LR: the [N x C x ...] tensor of degraded inputs.
        :param LR_bic: the [N x C x ...] tensor of interpolated images.
        :param matrix_list: the [N x C x ...] tensor of latitude distortion maps.
    ...
    def training_losses(
        ...
        :param HR: the [N x C x ...] tensor of inputs HR.
        :param LR_bic: the [N x C x ...] tensor of interpolated images.
        :param LR: the [N x C x ...] tensor of degraded inputs.
        :param matrix_list: the [N x C x ...] tensor of latitude distortion maps.
        ...
        z_BIC = self.encode_first_stage(LR_bic, matrix_list, first_stage_model)
        z_start = self.encode_first_stage(HR, matrix_list, first_stage_model)

        if noise is None:
            noise = th.randn_like(z_start)

        z_t = self.q_sample(z_start, z_BIC, t, noise=noise)
